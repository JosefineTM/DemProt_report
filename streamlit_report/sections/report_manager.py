...
Random_survival_forests = st.Page('Survival_models/Survival_models_Random_survival_forests.py', title='Random survival forests')
sections_pages['Survival models'] = [Random_survival_forests]

Introduction = st.Page('Random_forest_models/Random_forest_models_Introduction.py', title='Introduction')
Full_model = st.Page('Random_forest_models/Random_forest_models_Full_model.py', title='Full model')
Minimal_model = st.Page('Random_forest_models/Random_forest_models_Minimal_model.py', title='Minimal model')
Clinical_model = st.Page('Random_forest_models/Random_forest_models_Clinical_model.py', title='Clinical model')
Model_withouy_proteins = st.Page('Random_forest_models/Random_forest_models_Model_withouy_proteins.py', title='Model withouy proteins')
sections_pages['Random forest models'] = [Introduction, Full_model, Minimal_model, Clinical_model, Model_withouy_proteins]

Combined_model_performances = st.Page('Combined/Combined_Combined_model_performances.py', title='Combined model performances')
