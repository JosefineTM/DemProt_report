...
st.markdown(
    """<h3 style='text-align: center; color: #023558;'>Imputation</h3>""",
...
st.markdown(
    """<h4 style='text-align: center; color: #2b8cbe;'>Top 5 species by biome (plotly)</h4>""",
    unsafe_allow_html=True,
)
...
st.markdown(
    """<h4 style='text-align: center; color: #2b8cbe;'>Multiline plot (altair)</h4>""",
    unsafe_allow_html=True,
)
...
st.markdown(
    """<h4 style='text-align: center; color: #2b8cbe;'>Abundance data for all studies (csv)</h4>""",
    unsafe_allow_html=True,
)
...
st.markdown(
    """<h4 style='text-align: center; color: #2b8cbe;'>Abundance data for all studies (excel)</h4>""",
    unsafe_allow_html=True,
)
