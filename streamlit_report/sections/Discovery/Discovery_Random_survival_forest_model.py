...
st.markdown(
    """<h3 style='text-align: center; color: #023558;'>Random survival forest model</h3>""",
...
st.markdown(
    """<h4 style='text-align: center; color: #2b8cbe;'>Network2 (edge list csv)</h4>""",
    unsafe_allow_html=True,
)
...
st.markdown(
    f"<p style='text-align: center; color: black;'> <b>Number of nodes:</b> 9 </p>",
    unsafe_allow_html=True,
)
st.markdown(
    f"<p style='text-align: center; color: black;'> <b>Number of relationships:</b> 14 </p>",
    unsafe_allow_html=True,
)
