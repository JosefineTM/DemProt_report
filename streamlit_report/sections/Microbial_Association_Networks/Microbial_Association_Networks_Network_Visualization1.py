...
st.markdown('''<h3 style='text-align: center; color: #023558;'>Network Visualization1</h3>''', unsafe_allow_html=True)
st.markdown('''<p style='text-align: center; color: #000000;'></p>''', unsafe_allow_html=True)
st.markdown('''<h4 style='text-align: center; color: #2b8cbe;'>Network1 (graphml)</h4>''', unsafe_allow_html=True)

with open('example_data/network1.html', 'r') as f:
    html_data = f.read()
